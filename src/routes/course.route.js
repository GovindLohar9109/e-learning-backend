...
const router = express.Router();router.get("/courses/count", CourseController.getCoursesCount);
router.get("/courses/limit/:limit", CourseController.getCoursesByLimit);router.get("/courses/:course_id", CourseController.getCoursesDetailsById);
